...
export async function GET(req: NextRequest) {
  ...
  // YT directo sin TikTok - evita Cloudflare y 404
  try {
  ...
  return new NextResponse(`<!DOCTYPE html><html><body style="font-family:system-ui;padding:24px;background:#09090b;color:#fff"><h3>Buscando "${q}"</h3><p>Toca 2-3 arriba y dale a Listo</p></body></html>`, { status: 200, headers: { "Content-Type": "text/html; charset=utf-8", "X-Frame-Options": "ALLOWALL", "Content-Security-Policy": "frame-ancestors *" } });
}
